...
with webdriver.Chrome() as driver:
    ...
    driver.find_element(value="member_password").send_keys(os.environ["PASSWORD"].strip())
    driver.find_element(By.NAME, "commit").click()

    i = 1
    while i <= 3:
        driver.get(f'https://www.loot-studios.com/library?page={i}')
        products = {l.get_attribute("href") for l in driver.find_element(By.XPATH, "/html/body/div[1]/div/div[3]/div").find_elements(By.TAG_NAME, "a")}
        for product in products:
            if "library" in product or product in to_skip:
                continue

            driver.get(product)
            mainfolder = driver.find_element(By.XPATH, '/html/body/div[1]/div/div/div[3]/div/div/div/div/div/div/h1').text
            ...
            categories = set()
            syllabus = driver.find_element(By.XPATH, '//*[@id="section-product_syllabus"]/div/div')
            ...
            for category in categories:
                ...
                try:
                    downloads = driver.find_element(By.CLASS_NAME, "downloads").find_elements(By.TAG_NAME, "a")
                ...
                for d in downloads:
                    ...
                    with open("run.sh", "a") as f:
                        f.write(f'wget "{d.get_attribute("href")}" -O "{path}/{d.text}" &\n')
